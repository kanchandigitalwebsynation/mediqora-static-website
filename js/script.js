(() => {
    ...
    <header class="site-header">
      <div class="container header-inner">
        ...
        >
          ...
          <a
            class="${isActive("feature-solutions.html")}"
            href="feature-solutions.html"
          >
            Features &amp; Solutions
          </a>

          <a
            class="${isActive("pricing.html")}"
            href="pricing.html"
          >
            Pricing
          </a>
          ...
          <a
            class="${isActive("contactus.html") || isActive("bookdemo.html")}"
            href="contactus.html"
          >
            Contact / Book a Demo
          </a>
    ...
    <footer class="site-footer">
      ...
      <div class="container footer-main">
        ...
        <div class="footer-brand">
          ...
          <p>
            The all-in-one clinic management
            software for modern clinics and doctors.
            Built to simplify your work, so you can
  ...
  >
    <i class="fab fa-youtube"></i>
        ...
        <div class="footer-col">
          ...
          <a href="policypage.html#security">
            Security
          </a>

          <a href="policypage.html#data">
            Data Protection
          </a>
        ...
        <div class="footer-col">
          ...
          <a
            href="mailto:hello@mediqora.com"
          >
            hello@mediqora.com
          </a>
    ...
    <i class="fab fa-youtube"></i>
      ...
      <div class="footer-bottom-wrapper">
        ...
        <div class="container footer-bottom">
          ...
          <span class="tagline">
            Mediqora — Clinic Management Software
  ...
  document
    .querySelectorAll('a[href="#terms"], a[href="policypage.html#terms"]')
    .forEach((link) => {
      link.href = "terms.html";
    });

  document
    .querySelectorAll('a[href="#cookies"], a[href="policypage.html#cookies"]')
    .forEach((link) => {
  ...
  if (blogSearch) {
    ...
    document.querySelectorAll(".category-band button").forEach((button) => {
      button.addEventListener("click", () => {
        document.querySelectorAll(".category-band button").forEach((item) => {
          item.classList.remove("active");
        });

        if (category === button.dataset.cat) {
          category = "all";
        } else {
  ...
  if (businessStatus) {
    ...
    const parts = Object.fromEntries(
      istTime.map((part) => [part.type, part.value]),
    );
  ...
  if (faqItems.length) {
    ...
    document.querySelectorAll(".category-grid button").forEach((button) => {
      button.addEventListener("click", () => {
        document.querySelectorAll(".category-grid button").forEach((item) => {
          item.classList.remove("active");
        });
        ...
        document.querySelector(".faq-layout")?.scrollIntoView({
          behavior: "smooth",
  ...
  if (tourModal) {
    ...
    document.getElementById("watchTour")?.addEventListener("click", () => {
      openTour();
    });

    document.getElementById("inlinePlay")?.addEventListener("click", () => {
      openTour();
    });
  ...
  if (updateSearch) {
    ...
    document.querySelectorAll(".area-filter").forEach((checkbox) => {
      checkbox.addEventListener("change", filterUpdates);
    });

    document.querySelectorAll(".update-tabs button").forEach((button) => {
      button.addEventListener("click", () => {
        document.querySelectorAll(".update-tabs button").forEach((item) => {
          item.classList.remove("active");
        });
